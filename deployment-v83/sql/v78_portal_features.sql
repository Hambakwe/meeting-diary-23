...
('portal_version', 'v78', 'Client Portal version'),
('portal_features', 'documents,contacts,diary', 'Enabled portal features'),
...
SELECT 'Portal v78 features installed successfully!' AS message;
