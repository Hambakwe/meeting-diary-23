...
--
-- Usage:
-- mysql -u username -p database_name < v96_portal_features.sql
-- ============================================================
...
('portal_version', 'v96', 'Client Portal version'),
...
UPDATE `system_settings` SET `value` = 'v96', `updated_at` = NOW() WHERE `key` = 'portal_version';
