...
--
-- Usage:
-- mysql -u username -p database_name < v78_portal_features.sql
-- ============================================================
...
('portal_version', 'v84', 'Client Portal version'),
...
SELECT 'Portal v84 features installed successfully!' AS message;
