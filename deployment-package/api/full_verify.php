...
$versionFiles = array(
    // Core API files
    'api/config.php' => array('path' => $apiDir . '/config.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Database configuration'),
    'api/projects.php' => array('path' => $apiDir . '/projects.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Projects API'),
    'api/tasks.php' => array('path' => $apiDir . '/tasks.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Tasks API'),
    'api/templates.php' => array('path' => $apiDir . '/templates.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Templates API'),
    'api/comments.php' => array('path' => $apiDir . '/comments.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Comments API'),
    'api/auth.php' => array('path' => $apiDir . '/auth.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Authentication API'),
    'api/statistics.php' => array('path' => $apiDir . '/statistics.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Statistics API'),
    // Portal APIs
    'api/documents.php' => array('path' => $apiDir . '/documents.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Documents API'),
    'api/contacts.php' => array('path' => $apiDir . '/contacts.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Team Contacts API'),
    'api/diary.php' => array('path' => $apiDir . '/diary.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Diary/Calendar API'),
    // Login system
    'login.php' => array('path' => $baseDir . '/login.php', 'marker' => '@version v95', 'required' => true, 'desc' => 'Popup login page'),
    'login-embed.js' => array('path' => $baseDir . '/login-embed.js', 'marker' => '@version v95', 'required' => true, 'desc' => 'Login embed script'),
    // Frontend pages
    ...
    // SQL Scripts
    'sql/v95_portal_features.sql' => array('path' => $baseDir . '/sql/v95_portal_features.sql', 'marker' => 'Version: v95', 'required' => true, 'desc' => 'Portal features SQL'),
);
...
if ($dbConnected) {
    ...
    if ($portalTablesExist === 0) {
        showFail("Portal tables not found. Run: <code>sql/v95_portal_features.sql</code>");
    } elseif ($portalTablesExist < count($portalTables)) {
        showWarn("Some portal tables missing. Re-run: <code>sql/v95_portal_features.sql</code>");
    } else {
...
if ($dbConnected && in_array('system_settings', $existingTables)) {
    ...
    if (count($settings) > 0) {
        ...
        showWarn("No system settings found - run v95_portal_features.sql");
    }
} else {
...
<tr><td>1</td><td>Upload all files</td><td><code>gantt-project-manager-v95-portal.zip</code></td></tr>
<tr><td>2</td><td>Configure database</td><td>Edit <code>api/config.php</code></td></tr>
<tr><td>3</td><td>Run SQL scripts</td><td><code>schema.sql → seed.sql → templates_schema.sql → v95_portal_features.sql</code></td></tr>
...
<pre>mysql -u username -p database_name &lt; sql/v95_portal_features.sql</pre>
