 ...
 * ============================================
 * Version: 2.0 (PHP 7.3+ Compatible)
 * Updated: 2026-02-07
 *
 * Handles uploading person photos to pers-img directory
 *
 * IMPORTANT: This version is compatible with PHP 7.3+
 * (Does NOT use match() or other PHP 8+ features)
 * ============================================
 */
...
if (!isset($_FILES['photo']) || $_FILES['photo']['error'] !== UPLOAD_ERR_OK) {
    ...
    $errorCode = isset($_FILES['photo']['error']) ? $_FILES['photo']['error'] : UPLOAD_ERR_NO_FILE;
...
// Generate unique filename - PHP 7.x compatible
$extensionMap = array(
    'image/jpeg' => 'jpg',
    'image/png' => 'png',
    'image/gif' => 'gif',
