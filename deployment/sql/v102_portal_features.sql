...
--
-- Usage:
-- mysql -u username -p database_name < v102_portal_features.sql
-- ============================================================
...
('portal_version', 'v102', 'Client Portal version'),
...
-- Force update portal_version to v102
UPDATE `system_settings` SET `value` = 'v102', `updated_at` = NOW() WHERE `key` = 'portal_version';
...
SELECT 'Portal v102 features installed successfully!' AS message;
...
-- - Fixed Create Project Select component empty value error
-- - Updated all file version tags to v102
-- - Updated system_settings portal_version to v102
-- - Complete portal with all features: documents, contacts, diary, admin
-- ============================================================
