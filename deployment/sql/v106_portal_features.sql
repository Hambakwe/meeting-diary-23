...
('portal_version', 'v106', 'Client Portal version'),
...
UPDATE `system_settings` SET `value` = 'v106', `updated_at` = NOW() WHERE `key` = 'portal_version';
...
SELECT 'Portal v106 features installed successfully!' AS message;
...
-- ============================================================
-- v106 Changes:
-- - Fixed admin pages flashing and redirecting to dashboard on load
-- - Fixed race condition in auth state initialization
-- - Added proper authInitialized state to AuthProvider
-- - Added loading spinner on admin pages while auth initializes
-- - Separated auth loading from projects loading state
-- - Updated all file version tags to v106
-- - Updated system_settings portal_version to v106
-- ============================================================
