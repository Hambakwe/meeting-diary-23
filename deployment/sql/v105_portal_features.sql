...
('portal_version', 'v105', 'Client Portal version'),
...
UPDATE `system_settings` SET `value` = 'v105', `updated_at` = NOW() WHERE `key` = 'portal_version';
...
SELECT 'Portal v105 features installed successfully!' AS message;
...
-- ============================================================
-- v105 Changes:
-- - Fixed admin navigation routing (.htaccess subdirectory handling)
-- - Fixed sidebar navigation links with trailing slashes
-- - Fixed Create Project and Allocate Client Select component errors
-- - Added Version API endpoint (/api/version.php)
-- - Added version display on Dashboard and Login pages
-- - Updated all file version tags to v105
-- - Updated system_settings portal_version to v105
-- ============================================================
