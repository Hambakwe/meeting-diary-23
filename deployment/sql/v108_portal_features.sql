...
--
-- Usage:
-- mysql -u username -p database_name < v105_portal_features.sql
-- ============================================================
...
(1, 1, 'Deal Team Weekly Sync', 'Weekly sync with the full deal team to review progress', '2026-02-22', '10:00:00', '11:00:00', 'Zoom', 2),
(1, 2, 'Credit Rating Call', 'Call with Moody''s regarding credit rating application', '2026-02-22', '14:00:00', '15:00:00', NULL, 2),
...
('portal_version', 'v108', 'Client Portal version'),
...
('portal_build_date', '2026-02-22', 'Portal build date')
ON DUPLICATE KEY UPDATE `value` = VALUES(`value`), `updated_at` = NOW();

-- Force update portal_version to v105
UPDATE `system_settings` SET `value` = 'v108', `updated_at` = NOW() WHERE `key` = 'portal_version';
...
SELECT 'Portal v108 features installed successfully!' AS message;
...
-- ============================================================
-- v108 Changes:
-- - Fixed logo display - removed unwanted background/frame around logos
-- - Changed to use single transparent logo (OCFLogoSTrans.png) with CSS invert filter
-- - LoginDialog uses inverted logo on white background (appears dark)
-- - PortalSidebar mobile header uses inverted logo on light mode
-- - PortalSidebar desktop sidebar uses white logo on dark background
-- - Removed wrapper div around logo in sidebar (was adding potential styling)
-- - Updated all file version tags to v108
-- - Updated system_settings portal_version to v108
-- ============================================================
