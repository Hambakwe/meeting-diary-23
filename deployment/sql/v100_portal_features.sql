...
--
-- Usage:
-- mysql -u username -p database_name < v100_portal_features.sql
-- ============================================================
...
('portal_version', 'v100', 'Client Portal version'),
...
-- Force update portal_version to v100
UPDATE `system_settings` SET `value` = 'v100', `updated_at` = NOW() WHERE `key` = 'portal_version';
...
SELECT 'Portal v100 features installed successfully!' AS message;
...
-- ============================================================
-- v100 Changes:
-- - Major milestone release v100
-- - Complete portal deployment package
-- - Updated all file version tags to v100
-- - Updated system_settings portal_version to v100
-- - Includes all portal features: documents, contacts, diary, admin
-- - Full admin pages: Manage Projects, Allocate to Client, Templates
-- ============================================================
